 ...
 */
package one.digitalinnovation.checkout.event;
...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder newBuilder() {
    return new one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder newBuilder(one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder other) {
    return new one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder(other);
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder newBuilder(one.digitalinnovation.checkout.event.PaymentCreatedEvent other) {
    return new one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(one.digitalinnovation.checkout.event.PaymentCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder setCheckoutStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder clearCheckoutStatus() {
      checkoutStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public one.digitalinnovation.checkout.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
